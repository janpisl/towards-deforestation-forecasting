...
class ConvLSTMCell(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, bias, activation):
        """
...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, num_layers,
                 batch_first=True, bias=True, return_all_layers=False, activation='tanh'):
        super(ConvLSTM, self).__init__()

        self._check_kernel_size_consistency(kernel_size)
        # Extend parameters for multiple layers.
        ...
        for i in range(self.num_layers):
            ...
            # Create a BatchNorm3d for each layer.
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        for layer_idx in range(self.num_layers):
            ...
            # Stack along time dimension: (B, T, C, H, W)
            layer_output = torch.stack(output_inner, dim=1)
            # BatchNorm3d expects (B, C, T, H, W), so permute.
